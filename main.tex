...
\begin{frame}{Soberania Tecnológica: Criadores vs. Consumidores}
    \begin{itemize}
        ...
        \item O atual boom da Inteligência Artificial: ChatGPT, Gemini, Claude... onde está a tecnologia nacional?
        \item A urgência de deixarmos de ser apenas ``usuários premium'' para nos tornarmos \textbf{desenvolvedores} das nossas próprias soluções.
    \end{itemize}
\end{frame}
