# Visão Computacional e Deep Learning na Análise do Movimento de Atletas ��‍♂️��
...
## ��️ Como Compilar os Slides (LaTeX)
...
�� Leia o README da pasta src para entender o código passo a passo
...
Esse documento engloba perfeitamente todo o esforço que você colocou na estruturação da sua fala, valoriza o seu laboratório (sem vangloriar excessivamente, focando na missão metodológica) e deixa os links prontos para a comunidade. 

Gostaria que eu já gerasse o arquivo `.gitignore` para mantermos o seu repositório limpo, sem subir aqueles arquivos temporários chatos que o LaTeX cria (`.aux`, `.log`, `.out`, etc.)?