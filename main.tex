...
\begin{frame}{Quando o Padrão Falha: Limites do MediaPipe}
    \begin{itemize}
        \item \small \textbf{Instabilidade Técnica:} A instabilidade dos parâmetros em algoritmos padrões, que gera ``esqueletos fantasmas'', justifica a necessidade do LaBioCoM em assumir o controle total do algoritmo para garantir a precisão biomecânica.
    \end{itemize}

    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=3.8cm, keepaspectratio]{pk_binha2.png}
                
                \vspace{0.1cm}
                \scriptsize \textit{\textcolor{red}{\faExclamationTriangle} Limitação de Framework:\\Ruído de predição.}
            \end{center}
        \end{column}
        
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[height=3.8cm, keepaspectratio]{pk_binha1.png}
                
                \vspace{0.1cm}
                \scriptsize \textit{\textcolor{red}{\faExclamationTriangle} Falha de detecção:\\Alvo muito pequeno (Small).}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{\textit{vailá} Multimodal Toolbox: Integração e Liberdade \cite{santiago2024vaila}}
    \begin{columns}[c]
        ...
        \begin{column}{0.45\textwidth}
            \begin{center}
                \includegraphics[width=\textwidth, keepaspectratio]{vaila.png}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[standout]
    ...
    \begin{center}
        \begin{tcolorbox}[
            ...
            \centering
            \small \faGithub \hspace{1mm} \href{https://github.com/paulopreto}{github.com/paulopreto}
        \end{tcolorbox}
    \end{center}
\end{frame}
